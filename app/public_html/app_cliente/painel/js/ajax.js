...
//FUNÇÕES PAGINA CLIENTES
 ...
 $("#form_lancar").submit(function (event) {    
  event.preventDefault();
  ...
  $.ajax({
    url: '../../painel/paginas/clientes/lancar_valor.php',
    type: 'POST',
    data: formData,
    success: function (mensagem) {
      //ARMAZENAR O RETORNO PARA A MSG DE SUCESSO
 ...
 $("#form_solic").submit(function (event) {    
  event.preventDefault();
  
  var formData = new FormData(this);
  $('#btn_salvar_solic').hide();

  $.ajax({
    url: '../../painel_cliente/paginas/solicitar_emprestimo/salvar.php',
    type: 'POST',
    data: formData,
    success: function (mensagem) {
      //ARMAZENAR O RETORNO PARA A MSG DE SUCESSO

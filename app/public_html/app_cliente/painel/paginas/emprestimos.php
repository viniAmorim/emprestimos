...
//totalizar páginas
$query2 = $pdo->query("SELECT * from $pag where id > 0 and cliente = '$id_usuario' $sql_status  order by id desc");
...
<button id="btn_rel" type="submit"></button>
  ...
  <div class="card card-style">
    <div class="content">
      <?php
      $query = $pdo->query("SELECT * from $pag where id > 0 and cliente = '$id_usuario' $sql_status  ORDER BY id desc LIMIT $limite, $itens_pag");

...
<div id="footer-bar" class="footer-bar footer-bar-detached">
  <a class="<?php echo @$receber ?>" href="receber" onclick="navigateToPage(event, 'receber')"><i class="bi bi-currency-exchange font-15"></i><span>Contas</span></a>
...
<a class="<?php echo @$cobrancas ?>" href="cobrancas" onclick="navigateToPage(event, 'cobrancas')"><i class="bi bi-list-task font-17"></i><span>Cobranças</span></a>
<?php } ?>

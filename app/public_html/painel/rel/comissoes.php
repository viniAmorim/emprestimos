...
$texto_filtro = $datas.' '.$filtro_pendentesF;
		...
		<table style="width: 100%; border: 0px solid #ccc;">
			<tr>
				...
				<td style="width: 47%; text-align: right; font-size: 9px;padding-right: 10px;">
						<b><big>RELATÓRIO DE COMISSÕES </span></big></b><br> <?php echo mb_strtoupper($texto_filtro) ?> <br> <?php echo mb_strtoupper($data_hoje) ?>
				</td>
			</tr>		
		</table>
	</div>
...
$query = $pdo->query("SELECT * from pagar where data >= '$dataInicial' and data <= '$dataFinal' and pago LIKE '%$pago%' and referencia = 'Comissão' and funcionario = '$funcionario' order by data asc");
...
<td style="width:30%"><?php echo $nome_usu_pgto ?></td>

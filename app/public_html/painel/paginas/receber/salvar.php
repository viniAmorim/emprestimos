...
$query = $pdo->prepare("UPDATE $tabela SET descricao = :descricao, valor = :valor, data = curDate(), data_venc = '$data_venc', usuario_lanc = '$id_usuario', pago = 'Não', obs = :obs, cliente = '$cliente' where id = '$id'");
}

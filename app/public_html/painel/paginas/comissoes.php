...
<div class="bs-example widget-shadow" style="padding:15px">
		...
		<div class="col-md-5" style="margin-bottom:5px;">
			...
			<select class="form-control sel2" id="funcionario" name="funcionario" style="width:100%;" onchange="listar()"> 
				...
				if($nivel_usuario == 'Administrador'){
					echo '<option value="">Filtrar Funcionário</option>';
	...
	<div class="col-md-2">
		...
		<button type="submit" class="btn btn-primary"> <span class="fa fa-file-pdf-o"></span> Relatório</button>
		...
		<input type="hidden" id="buscar-contas" name="buscar-contas">

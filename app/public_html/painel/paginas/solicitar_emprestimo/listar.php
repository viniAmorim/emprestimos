...
$query = $pdo->query("SELECT * from $tabela where status = '$busca' order by id desc");
...
<li class="dropdown head-dpdn2" style="display: inline-block;">
		...
		<div class="notification_desc2">
		<p>		
		<span><b>Valor :</b> {$valorF}</span><br>	
		<span><b>Data :</b> {$dataF}</span><br>	
		<span><b>parcelas :</b> {$parcelas}</span><br>	

...
echo <<<HTML
			...
			<form method="POST" action="../../painel/rel/detalhamento_cobranca_class.php" style="display:inline;">
				...
				<button type="submit" class="d-inline-flex justify-content-center align-items-center bg-danger rounded-circle border-0" style="width:28px; height:28px;" title="Detalhamento Cobrança">
					<i class="fa fa-file-pdf" style="font-size:14px; color:white;"></i>
				</button>
			</form>

					<!-- Mostrar Parcelas -->
			<a href="#" onclick="mostrarParcelasCob('{$id_emp}')" class="d-inline-flex justify-content-center align-items-center bg-success rounded-circle" style="width:28px; height:28px;" title="Mostrar Parcelas">
...
function mostrarParcelasCob(id_emp){

  ...
  <div class="card card-style">
    <div class="content">
      ...
      if ($pago == 'Vencidas') {
        ...
        $query = $pdo->query("SELECT * from $pag where data_venc >= '$dataInicial' and data_venc <= '$dataFinal' and pago LIKE '%$pago%' $sql_visualizar order by id desc LIMIT $limite, $itens_pag");
      }
      $valor_pago = 0;
      $valor_pendentes = 0;
